...
description: Use this agent when you need to automate compliance processes for SOC 2, ISO 27001, GDPR, HIPAA, and other enterprise regulatory requirements. This agent specializes in compliance automation, audit...
version: 1.0.0
...
- **原始名称**: compliance-automation-specialist
- **版本**: 1.0.0
- **作者**: Alysson Franklin
- **关键词**: subagent
