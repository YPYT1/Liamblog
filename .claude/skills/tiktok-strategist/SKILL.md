...
description: Use this agent when you need to create TikTok marketing strategies, develop viral content ideas, plan TikTok campaigns, or optimize for TikToks algorithm. This agent specializes in creating shareab...
version: 1.0.0
...
Use this agent when you need to create TikTok marketing strategies, develop viral content ideas, plan TikTok campaigns, or optimize for TikToks algorithm. This agent specializes in creating shareab...

## 来源信息

- **原始平台**: Claude Code
- **市场来源**: Claude Code Marketplace
- **原始名称**: tiktok-strategist
- **版本**: 1.0.0
- **作者**: Michael Galpert
- **关键词**: subagent
