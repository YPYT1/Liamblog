...
description: |
  MUST BE USED PROACTIVELY when user mentions: planning, PRD, product requirements 
  document, project plan, roadmap, specification, requirements analysis, feature 
  breakdown, technical spec, project es...
version: 1.0.0
author: clouddna-au
...
MUST BE USED PROACTIVELY when user mentions: planning, PRD, product requirements document, project plan, roadmap, specification, requirements analysis, feature breakdown, technical spec, project es...

## 来源信息

- **原始平台**: Claude Code
- **市场来源**: Claude Code Marketplace
- **原始名称**: planning-prd-agent
- **版本**: 1.0.0
- **作者**: clouddna-au
- **关键词**: subagent
