...
description: Use this agent when you need to identify market opportunities, analyze trending topics, research viral content, or understand emerging user behaviors. This agent specializes in finding product oppo...
version: 1.0.0
...
Use this agent when you need to identify market opportunities, analyze trending topics, research viral content, or understand emerging user behaviors. This agent specializes in finding product oppo...

## 来源信息

- **原始平台**: Claude Code
- **市场来源**: Claude Code Marketplace
- **原始名称**: trend-researcher
- **版本**: 1.0.0
- **作者**: Michael Galpert
- **关键词**: subagent
