...
description: Use this agent when creating visual narratives, designing infographics, building presentations, or communicating complex ideas through imagery. This agent specializes in transforming data and conce...
version: 1.0.0
...
Use this agent when creating visual narratives, designing infographics, building presentations, or communicating complex ideas through imagery. This agent specializes in transforming data and conce...

## 来源信息

- **原始平台**: Claude Code
- **市场来源**: Claude Code Marketplace
- **原始名称**: visual-storyteller
- **版本**: 1.0.0
- **作者**: Michael Galpert
- **关键词**: subagent
